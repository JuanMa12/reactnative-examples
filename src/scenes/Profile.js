  ...
  return (
    <ScrollView>
      ...
      <View style={styles.promotion}>
        ...
        source= {{
          uri : 'https://tolitur.com/wp-content/uploads/2021/01/1c.png'
        }}>
        </Image>
      </View>
      <View style={styles.promotion}>
